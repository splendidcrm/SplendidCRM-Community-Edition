...
{
	/// <summary>
	/// Summary description for PopupPersonalInfo.
	/// </summary>
	public class PopupPersonalInfo : SplendidPopup
	{
		protected Guid          gID            ;
		...
		// 10/31/2021 Paul.  Moved BuildChangesTable to ModuleUtils from Audit/PopupPersonalInfo. 
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				if ( !Sql.IsEmptyString(sModule) && !Sql.IsEmptyGuid(gID) )
				{
					...
					// 10/31/2021 Paul.  Moved GetAuditData to ModuleUtils from Audit/PopupPersonalInfo. 
					DataTable dtChanges = ModuleUtils.AuditPersonalInfo.GetAuditData(Application, L10n, T10n, sModule, gID, ref sNAME, sbSQLCode);
