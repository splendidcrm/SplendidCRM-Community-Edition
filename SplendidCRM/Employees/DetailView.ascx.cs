								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											// 05/26/2020 Paul.  Button access rights need to be moved to a point after they are created. 
											...
											// 10/09/2020 Paul.  ResetDefaults has never been coded. 
											ctlDynamicButtons.ShowButton("ResetDefaults" , (SplendidCRM.Security.AdminUserAccess(m_sMODULE, "edit") >= 0) && false);
