...
@Component({
	selector: 'EditViewUnknown',
	template: `<span>Unknown EditView type {{ template.tag }}</span>`
})
export class EditViewUnknownComponent extends EditViewComponentBase implements OnInit
{
	public get data(): any
	{
		return null;
