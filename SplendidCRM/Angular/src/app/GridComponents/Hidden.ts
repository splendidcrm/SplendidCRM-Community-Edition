...
@Component({
	...
	<ng-container *ngIf="IsVisible()">
		<div [id]="baseId + '_' + DATA_FIELD" style="display: none">{{ DATA_VALUE }}</div>
	</ng-container>`
})
export class SplendidGridHiddenComponent extends SplendidGridComponentBase implements OnInit
{
