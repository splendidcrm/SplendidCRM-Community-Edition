...
@Component({
	...
	<ng-container *ngIf="IsVisible()">
		<input type='checkbox' [checked]="DATA_VALUE" [disabled]="true" />
	</ng-container>`
})
export class SplendidGridCheckBoxComponent extends SplendidGridComponentBase implements OnInit
{
