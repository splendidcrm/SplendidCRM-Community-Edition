...
export class SplendidGridImageComponent extends SplendidGridComponentBase implements OnInit
{
	...
	ngOnInit()
	{
		...
		// 06/16/2022 Paul.  Image not supported at this time. 
