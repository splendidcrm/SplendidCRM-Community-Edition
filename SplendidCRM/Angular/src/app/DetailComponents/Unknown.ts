...
@Component({
	selector: 'DetailViewUnknown',
	template: `<span>Unknown DetailView type {{ layout.FIELD_TYPE }}</span>`
})
export class DetailViewUnknownComponent extends DetailViewComponentBase implements OnInit
{
